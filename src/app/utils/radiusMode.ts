...
// export class RadiusMode extends MapboxDraw.modes.draw_line_string {
//     public createVertex(parentId, coordinates, path, selected) {
//         return {
//             type: 'Feature',
//             properties: {
//                 meta: 'vertex',
...
//    public createGeoJSONCircle(center, radiusInKm, parentId, points = 64) {
//         const coords = {
//             latitude: center[1],
//             longitude: center[0],
//         };
...
//    public getDisplayMeasurements(feature) {
...
//     public static clickAnywhere(state, e) {
//         // this ends the drawing after the user creates a second point, triggering this.onStop
//         if (state.currentVertexPosition === 1) {
//             state.line.addCoordinate(0, e.lngLat.lng, e.lngLat.lat);
//             return super.changeMode('simple_select', { featureIds: [state.line.id] });
//         }
//         super.updateUIClasses({ mouse: 'add' });
...
//     public static onStop(state) {
//         this.doubleClickZoom.enable(this);

//         super.activateUIButton();

//         // check to see if we've deleted this feature
//         if (super.getFeature(state.line.id) === undefined) return;
...
//             super.map.fire('draw.create', {
//                 features: [pointWithRadius],
//             });
//         } else {
//             super.deleteFeature([state.line.id], { silent: true });
//             super.changeMode('simple_select', {}, { silent: true });
//         }
//     };



//     public static toDisplayFeatures (state, geojson, display) {
