...
export class Report{
    ...
    codTemaSintetico: number; //ocCodTemaSintetico: number; mostrato in dettaglio e uusato per filtro secondario con chips
    ...
    codCicloProgrammazione?: string; //codLocaleProgetto?: string;  mostrato in dettaglio, usato per filtro secondario con chips
